...
/**
 * This method is to insert(read) data from the shared buffer
 * \param conn pointer to the current connection
 * \param sbuffer pointer to pointer of shared data structure
 * 
 */
int insert_sensor_from_buffer(DBCONN *conn, sbuffer_t **sbuffer);
